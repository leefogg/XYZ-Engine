...
namespace GLOOP
{
    public class ImGuiController : IDisposable
    {
        ...
        public void CreateDeviceResources()
        {
            ...
            var vaoName = $"IMGUI VAO";
            GL.ObjectLabel(ObjectLabelIdentifier.VertexArray, _vertexArray, vaoName.Length, vaoName);

            GL.CreateBuffers(1, out _vertexBuffer);
            var vboName = "IMGUI VBO";
            GL.ObjectLabel(ObjectLabelIdentifier.Buffer, _vertexBuffer, vboName.Length, vboName);

            GL.CreateBuffers(1, out _indexBuffer);
            var eboName = "IMGUI EBO";
            GL.ObjectLabel(ObjectLabelIdentifier.Buffer, _indexBuffer, eboName.Length, eboName);
...
void main()
{
    outputColor = color * texture(in_fontTexture, texCoord);
            ...
            _shader = new StaticPixelShader(VertexSource, FragmentSource, "ImGui");
        ...
        public void RecreateFontDeviceTexture()
        {
            ...
            var texParams = new TextureParams()
            {
                ...
                Name = "ImGui Text Atlas",
                Data = pixels,
            };
            _fontTexture = new Texture2D(width, height, texParams);
        ...
        private void RenderImDrawData(ImDrawDataPtr draw_data)
        {
            ...
            for (int n = 0; n < draw_data.CmdListsCount; n++)
            {
                ...
                {
                    ImDrawCmdPtr pcmd = cmd_list.CmdBuffer[i];
